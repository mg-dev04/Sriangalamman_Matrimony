    ...
    return(
        <div>
            ...
            <div className='container'>
                <p>This electronic website is being operated and owned by sriangalammanmatrimony.com This PRIVACY POLICY STATEMENT is made/published in the internet web site to protect the user’s privacy and it is connected to our terms and conditions.</p>
                <p>A user/member, when he is entering our web site after accepting our full terms and conditions of sriangalammanmatrimony.com should provide the mandatory information, he has the option of not providing the information which is not mandatory. User/Member is solely responsible for maintaining confidentiality of the User Name/Identity and User Password and all activities and transmission/transactions performed by the User through his/her user identity/name and shall be solely responsible for carrying out any online or off-line transactions involving credit/debit cards or such other forms of instruments or documents for making such transactions. As such, while doing so any negligence of your act, sriangalammanmatrimony.com assumes no responsibility / liability for their improper use of information relating to such usage of credit/debit cards used by the subscriber online/offline.</p>
